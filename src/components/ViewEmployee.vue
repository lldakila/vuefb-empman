<template>
    <div id="view-employee">
        ...
        <button @click="deleteEmployee" to="/" class="btn red">
            Delete
        </button>

        <div class="fixed-action-btn">
            <router-link v-bind:to="{name: 'edit-employee',params:{employee_id: employee_id}}" class="btn-floating btn-large primary">
